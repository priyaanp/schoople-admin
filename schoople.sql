...
SELECT pg_catalog.setval('public.school_student_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.school_subscription_module_role_permission_id_seq', 8, true);
...
COPY public.staffs_grades (id, schools_grades_sections_id, staff_id, subject_id, is_class_in_charge, is_class_in_charge_second) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.staffs_grades_id_seq', 1, false);
...
7	4	\N	jacob	scrypt:32768:8:1$qtYFbTs0DAjsxtbX$c4ad609b44c1b7c2ab2424d8d97f00251438c3c3ad0943bc7ecdef0016db247f986d09fdf2d9dc6d7240b7ba529d03a68498c1642abe56b7b1e06ce2792b310e	t
